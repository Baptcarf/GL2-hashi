...
public class TechniqueController extends ManageController {
    ...
    /**
     * Gérer le clic sur une technique : charger le contenu correspondant à la
    ...
    private void loadTechniqueContent(String id) {
        ...
        switch (id) {
            case "1":
                ...
                addBodyText(
                        "Certaines îles exigent le maximum absolu de connexions possibles. C'est mathématique :\n\n" +
                ...
                addActionBox(
                        "Action : Ces îles ne laissent aucun choix. Tracez des doubles ponts vers TOUS leurs voisins et marquez-les comme terminées (X).");
            ...
            case "2":
                ...
                addBodyText(
                        "Observez l'île '1' dans la rangée du bas : elle n'a qu'un seul voisin à sa droite. Elle est donc obligée de s'y connecter.\n\n"
                                +
                ...
                addActionBox(
                        "Action : Tracez les ponts pour ces îles, puis marquez-les d'une croix (X) car elles sont terminées.");
            ...
            case "3":
                ...
                addBodyText(
                        "Un '3' situé dans un coin a deux voisins. Est-il possible qu'il n'envoie aucun pont vers l'un d'eux ?\n\n"
                                +
                                "Non ! Car même si l'autre voisin prenait le maximum de ponts (2), il manquerait encore un pont pour atteindre 3.");
                addActionBox(
                        "Action : Par sécurité, vous pouvez tracer au moins 1 pont vers chacun des deux voisins. Le troisième pont sera déterminé plus tard.");
            ...
            case "4":
                ...
                addBodyText(
                        "Reprenons notre '3' dans le coin. Cette fois, observez ses voisins. L'un d'eux est un '1'.\n\n"
                                +
            ...
            case "5":
                ...
                addActionBox(
                        "Action : Dans cette configuration précise, il est sûr de tracer au moins 1 pont vers chacun des trois voisins.");
            ...
            case "6":
                ...
                addActionBox(
                        "Action : Un '6' doit obligatoirement être relié à ses 4 voisins. Tracez au moins 1 pont vers chacun d'eux.");
            ...
            case "7":
                ...
                addActionBox(
                        "Action : Il est INTERDIT de relier ces deux '1'. Vous devez obligatoirement les relier à leurs autres voisins respectifs.");
            ...
            case "8":
                ...
                addBodyText(
                        "Imaginez trois îles alignées (par exemple 1-2-1). Si vous les reliez toutes entre elles, le '2' central sera satisfait, et les '1' aussi.\n\n"
                                +
                                "Problème : Ce trio forme un îlot autonome isolé du reste du puzzle. C'est impossible.");
                addActionBox(
                        "Action : Vous devez 'casser' ce groupe fermé. Le '2' doit obligatoirement chercher une connexion vers l'extérieur.");
            ...
            case "9":
                ...
                addBodyText(
                        "Vous avez construit une longue chaîne d'îles qui serpente sur le plateau ? Attention aux extrémités !\n\n"
                                +
                ...
                addActionBox(
                        "Action : Ne fermez jamais une longue boucle si d'autres îles doivent encore être rattachées. Laissez une ouverture.");
            ...
            case "10":
                ...
                addActionBox(
                        "Action : Privilégiez les ponts qui agissent comme des 'connecteurs' entre deux zones distinctes du plateau.");
            ...
            case "11":
                ...
                addBodyText(
                        "Regardez l'espace entre ces deux îles. Imaginez que vous traciez un pont ici (ligne rouge).\n\n"
                                +
                ...
                addActionBox(
                        "Action : Puisque le pont est impossible, l'île doit obligatoirement se connecter dans l'autre direction disponible.");
            ...
            case "12":
                ...
                addBodyText(
                        "Analysez la structure du réseau. Parfois, un groupe d'îles ne possède qu'une seule 'porte de sortie' vers le reste du plateau.\n\n"
                                +
                                "Si vous ne mettez pas de pont à cet endroit précis, ce groupe mourra isolé.");
                addActionBox(
                        "Action : Ce pont est critique et obligatoire. Tracez-le pour garantir la connectivité globale.");
            ...
            case "13":
                ...
                addBodyText(
                        "Observez le '1'. S'il ne se connecte pas au '2' voisin, le '2' sera forcé de se connecter ailleurs.\n\n"
                                +
            ...
            case "14":
                ...
                addBodyText(
                        "Faisons une hypothèse : Si je connecte l'île A vers la droite, cela force l'île B à aller vers le bas.\n\n"
                                +
                ...
                addActionBox(
                        "Action : L'hypothèse A vers la droite mène à une erreur. Il faut donc faire l'inverse (A ne va pas à droite).");
    ...
    /**
     * Ajouter une boîte d'action avec un style distinctif pour mettre en avant les
     * conseils pratiques
     * 
    ...
    private void addActionBox(String text) {
        ...
        lbl.setStyle(
                "-fx-background-color: #e8f8f5; -fx-text-fill: #27ae60; -fx-padding: 10; -fx-background-radius: 5; -fx-border-color: #27ae60; -fx-border-radius: 5;");
